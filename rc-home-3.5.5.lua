...
for s = 1, screen.count() do
   ...
   if s == screen.count() then
      ...
      tags[s] = awful.tag({ 1, 2, 3, 4, 5, 6, 7, 8, 9 }, s, layouts[1])
      awful.layout.set(layouts[6], tags[s][1])
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "x", function () awful.util.spawn("run-asp " .. terminal) end),
...
awful.rules.rules = {
    ...
    { rule = { },
      except = { { class = "Gnome-panel" }, { class = "Mate-panel" } },
    ...
    { rule = { class = "Gimp" },
      properties = { floating = true } },
    { rule = { instance = "sun-awt-X11-XDialogPeer" },
      properties = { size_hints_honor = true, floating = true } },
    { rule = { class = "Steam" },
      properties = { tag = tags[1][4],
		     switchtotag = true,
		     } },
    { rule = { instance = "launcher.exe" },
      properties = { tag = tags[1][3],
		     switchtotag = true,
		     } },
    { rule = { instance = "ExeFile.exe" },
      properties = { tag = tags[1][3],
		     switchtotag = true,
		     } },
--    { rule = { name = "Solar2" },
...
--		     } },
    ...
    { rule = { instance = "WorldOfTanks.exe" },
      properties = { tag = tags[1][3],
		     switchtotag = true,
		     fullscreen = true,
		     floating = true,
		   } },
    { rule = { class = "Mythfrontend.real" },
